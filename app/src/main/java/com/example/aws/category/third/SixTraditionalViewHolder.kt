...
class SixTraditionalViewHolder(val context: ThirdActivity, private val binding: ThirdCategoryItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:SixTraditionalItemData){
