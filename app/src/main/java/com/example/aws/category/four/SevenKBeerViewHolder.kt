...
class SevenKBeerViewHolder(val context: FourthActivity, private val binding: FourthCategoryItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:SevenKBeerItemData){
