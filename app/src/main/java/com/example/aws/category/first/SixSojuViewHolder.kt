...
class SixSojuViewHolder(val context: Context, private val binding: CategorySojuSixItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:SixSojuItemData){
