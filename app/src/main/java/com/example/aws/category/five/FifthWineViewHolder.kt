...
class FifthWineViewHolder(val context: FifthActivity, private val binding: FifthCategoryItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:FifthWineItemData){
