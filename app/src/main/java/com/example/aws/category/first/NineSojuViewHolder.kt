...
class NineSojuViewHolder(val context: Context, private val binding: CategorySojuNineItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:NineSojuItemData){
