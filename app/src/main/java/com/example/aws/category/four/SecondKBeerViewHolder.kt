...
class SecondKBeerViewHolder(val context: FourthActivity, private val binding: FourthCategoryItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:SecondKBeerItemData){
