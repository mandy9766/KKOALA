...
class SevenLiquorViewHolder(val context: SixActivity, private val binding: SixCategoryItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:SevenliquorItemData){
