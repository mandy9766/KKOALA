...
class FourthLiquorViewHolder(val context: SixActivity, private val binding: SixCategoryItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:FourthliquorItemData){
