...
class FIfthBeerViewHloder(val context: SecondActivity, private val binding: SecondCategoryItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item: FifthBeerItemData){
