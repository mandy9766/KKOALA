...
class FourthSojuViewHolder(val context: Context, private val binding: CategorySojuFourthItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:FourthSojuItemData){
