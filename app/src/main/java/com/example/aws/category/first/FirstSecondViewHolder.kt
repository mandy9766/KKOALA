...
class FirstSecondViewHolder(val context: Context, private val binding: CatecoryFirstItemBinding): RecyclerView.ViewHolder(binding.root) {

    fun view(item:FirstSecondItemData){
